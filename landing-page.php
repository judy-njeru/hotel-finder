...
<body>
    <div class="navbarContainer">
        <div id="navbar"> 
            ...
            <div class="nav-right">
                <div class="loginUser">LOGIN</div>
                <div class="signUpUser">SIGNUP</div>
            </div> 
        </div>
    </div>
    ...
    <div id="backgroundBanner">
        ...
        <!-- <div id="bgSupportText">
            <p>Find and book your ideal hotel</p>
            <h1>Explore hotel <br>finder</h1>
            <button class="signUpUser" id="btnSignUpUser">Signup</button>
        </div> -->
    </div>

    <!--------------------- SIGN UP USER ----------------->
    <form id="frmSignupUser" class="modal frmSignupUser">
        <div class="modal-content animate" >
            ...
            <div class="container">
                ...
                <input id="txtName" type="text"  name="txtName" placeholder="Name">
                ...
                <input  id="txtConfirmPassword" type="password"  name="txtConfirmPassword" placeholder="ConfirmPassword">
                
                <button class="btnSignUpUser" type="submit">Signup</button>
    ...
    <!--------------------- LOGIN UP USER ----------------->
    <form id="frmLoginUser" class="loginModal frmLoginUser">
        <div class="modal-content animate" >
            <div class="closeOverlay">
                <span class='close' title="Close Modal">&times;</span>
            </div>
            ...
            <div class="container">
                ...
                <button class="btnLoginUser" type="submit">Login</button>
